Shader "Custom/Haumea_Planet"
{
    Properties
    {
        ...
        _Color1 ("Color planet 1", Color) = (1,1,1,1)
        _Color2 ("Color planet 2", Color) = (1,1,1,1)
        _Color3 ("Color planet 2", Color) = (1,1,1,1)

        _Height ("Height", Range(-1, 1)) = 0
        _Seed ("Seed", Range(0, 10000)) = 100
    }
    SubShader
    {
